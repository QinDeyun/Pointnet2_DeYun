...
class get_model(nn.Module):
    def __init__(self,normal_channel=False):
        ...
        self.sa1 = PointNetSetAbstractionMsg(1024, [0.1, 0.2, 0.4], [16, 32, 128], in_channel,[[32, 32, 64], [64, 64, 128], [64, 96, 128]]) #多半径的特征提取。[32, 32, 64], [64, 64, 128], [64, 96, 128]为卷积特征个数。
        self.sa2 = PointNetSetAbstractionMsg(512, [0.2, 0.4, 0.8], [32, 64, 128], 320,[[64, 64, 128], [128, 128, 256], [128, 128, 256]]) #在512个点中选择128个点，320为通道数。
...
class get_loss(nn.Module):
    ...
    def forward(self, pred, target, trans_feat):
        # 对于回归任务，使用均方误差损失函数
        total_loss = F.mse_loss(pred, target)  # 均方误差
        return total_loss
